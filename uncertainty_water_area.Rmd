...
```{r plot_missing3, cache=TRUE, dependson="log10", fig.height=3, fig.width=4, dev="tikz"}
...
```{r sensitivity, cache=TRUE, dependson=c("sensitivity_settings", "arrange_output", "set_sample_matrix")}
...
```{r plot_sobol, cache=TRUE, dependson="sensitivity", dev="tikz", fig.cap="Sobol' indices.", fig.width = 5}
...
```{r plot_sobol_second_third, cache=TRUE, dependson="sensitivity", dev = "tikz", fig.cap="High-order interactions between the triggers."}
